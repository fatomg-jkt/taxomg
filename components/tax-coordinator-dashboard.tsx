...
export function TaxCoordinatorDashboard() {
  ...
  const summaryRows = useMemo(() => page === "dashboard" ? filtered : filtered.filter(isManualInput), [page, filtered]);
