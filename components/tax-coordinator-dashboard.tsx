...
function buildKpis(page: Page, rows: TaxTransaction[], _overrides: SummaryOverrides = {}): KpiItem[] {
  void _overrides;
  if (page === "ppn") return [{ label: "Total PPN Keluaran", value: ppnOutput(rows), money: true }, { label: "Total PPN Masukan", value: ppnInput(rows), money: true }, { label: "PM Tidak Dikreditkan", value: ppnNonCreditable(rows), money: true }, { label: "Kurang Bayar/Lebih Bayar", value: ppnPayment(rows), money: true }, { label: "Total Pembayaran PPN", value: ppnPayment(rows), money: true }];
